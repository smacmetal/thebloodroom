...
const MESSAGES_DIR = path.join(ROOT, "data", "queen", "messages");
...
export async function GET() {
  try {
    ...
    console.error("Error reading Queen messages:", err);
...
export async function POST(req: Request) {
  try {
    ...
    const payload = {
      ...
      recipients: Array.isArray(data.recipients) ? data.recipients : ["Queen"],
    ...
    console.error("Error writing Queen message:", err);
...
export async function DELETE(req: Request) {
  try {
    ...
    console.error("Error deleting Queen message:", err);
